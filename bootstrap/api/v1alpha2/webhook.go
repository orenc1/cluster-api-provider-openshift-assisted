...
// +kubebuilder:webhook:path=/validate-bootstrap-cluster-x-k8s-io-v1alpha2-openshiftassistedconfig,mutating=false,failurePolicy=fail,sideEffects=None,groups=bootstrap.cluster.x-k8s.io,resources=openshiftassistedconfigs,verbs=create;update;delete,name=v1alpha2.validation.openshiftassistedconfig.bootstrap.cluster.x-k8s.io,versions=v1alpha2,admissionReviewVersions=v1,serviceName=webhook-service,serviceNamespace=capoa-bootstrap-system
